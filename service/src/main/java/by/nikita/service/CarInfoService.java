...
public class CarInfoService {
    ...
    private CarInfoService() {
        ...
        cars.get("Nik").add(new CarInfo(
                ...
                "The E34 generation of the M5 was produced from September 1988 to August 1995. Powered by the S38 straight-6 engine, an evolution of the previous generation's straight-6, it was initially produced in a sedan body style, with a LHD Touring (wagon/estate) version following in 1992. Production of M5 models began with the painted bodyshell of an E34 5 Series at the BMW Dingolfing plant.[19] The shells were then transported to BMW M GmbH in Garching, where the car was assembled by hand over a period of two weeks.[20][21] Only the South African M5 was entirely assembled at the Rosslyn, South Africa assembly plant from complete knock-down kits supplied from Garching, Germany. The M5 Touring, which was BMW M Division's first wagon as well as the last hand-built M car, saw 891 units produced. Total production of the E34 M5 was 12,254 units.[19]\n" +
                        ...
                        "\n" +
                        "The second-generation M5 was introduced with the S38B36 engine, which generated 232 kW (315 PS; 311 hp) at 6,900 rpm and 360 N⋅m (266 lb⋅ft) of torque at 4,750 rpm,[22] touting a factory 0-97 km/h (60 mph) acceleration figure of 6.3 seconds.[22] Top speed was electronically limited to 250kmh – 155 mph. ",
                "BMW M5 e34"));
    ...
    public List<CarInfo> getCars(String username) {
